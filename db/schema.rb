...
ActiveRecord::Schema.define(version: 2019_10_24_182619) do
  ...
  create_table "knowledges", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["dog_id"], name: "index_knowledges_on_dog_id"
    t.index ["stroll_id"], name: "index_knowledges_on_stroll_id"
  end
